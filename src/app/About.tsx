...
export default function About() {
  return (
    <section id="about" className="min-h-screen bg-[#050B1A] text-white py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
        {/* Hero Header */}
        <header className="mb-12 sm:mb-16 text-center">
          <div className="inline-block mb-4 sm:mb-8">
            <span className="text-xs sm:text-sm tracking-[0.3em] uppercase text-white/50">About</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Founder card - Larger */}
          <article className="lg:col-span-5 bg-gradient-to-br from-white/3 via-blue-500/3 to-transparent p-6 sm:p-8 lg:p-10 rounded-2xl border border-white/6">
            <div className="flex items-start gap-8 mb-12">
              <div className="w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-white/10 to-blue-500/10 border border-white/10 flex-shrink-0 flex items-center justify-center text-xl sm:text-3xl font-bold">
                KN
              </div>
              <div className="flex-1">
                <h3 className="font-bold text-xl sm:text-2xl md:text-3xl">K. Niklesh</h3>
                <p className="mt-1 text-sm sm:text-base text-white/70">Founder & Chief Architect</p>
            ...
            <div className="space-y-8">
              <div>
                <h4 className="font-semibold text-lg sm:text-xl mb-3 sm:mb-4 text-white">Core Philosophy</h4>
          ...
          <div className="lg:col-span-7 space-y-8">
            {/* Mission Section */}
            <section className="bg-white/3 p-6 sm:p-8 md:p-10 rounded-2xl border border-white/6">
              <div className="mb-10">
            ...
            {/* Core Values Grid */}
            <section>
              <h4 className="font-bold text-2xl sm:text-3xl mb-6">Core Values</h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="p-6 sm:p-8 bg-gradient-to-br from-white/2 to-transparent rounded-xl border border-white/6">
            ...
            {/* Process Section */}
            <section className="p-6 sm:p-8 md:p-10 rounded-2xl border border-white/6 bg-gradient-to-br from-white/2 to-transparent">
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          <div className="text-center">
            ...
            <div className="text-white/70 text-sm sm:text-lg">Years Experience</div>
          </div>
          <div className="text-center">
        ...
        {/* CTA Section */}
        <div className="mt-12 sm:mt-20 p-6 sm:p-8 md:p-12 rounded-2xl bg-gradient-to-r from-white/3 via-blue-500/3 to-transparent border border-white/6">
          <div className="max-w-3xl mx-auto text-center">
            <h3 className="font-bold text-2xl sm:text-3xl md:text-4xl mb-4 sm:mb-6">Ready to Build Something Great?</h3>
            <p className="text-base sm:text-xl text-white/70 mb-6 sm:mb-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <div className="text-center sm:text-left">
                <p className="text-white/60 text-sm sm:text-lg">
                  contact us at{' '}
                  <a className="text-blue-400 hover:text-blue-300 font-medium inline-block py-2 px-3 min-h-[44px]" href="mailto:hello@zinstack.example">
                    +91 73826 74757
                  </a>
                </p>
              </div>
